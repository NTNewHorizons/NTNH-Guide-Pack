...
* Vanilla AE2 provides a way to connect networks wirelessly: the Quantum Ring. Each pair can wirelessly transmit up to 32 channels and <Color id="GREEN">can connect across dimensions</Color>. For details, see [Quantum Ring](./quantum-bridge.md).
